...
Configurar um ambiente Kubernetes no Azure, incluindo a configuração de um cluster AKS, identidade gerenciada, conta de armazenamento e integração com o Azure Container Registry (ACR).
...
* Deck de perguntas e respostas para validação de conhecimento.
